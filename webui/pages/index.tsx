                ...
                <div className="flex justify-between items-end max-w-2xl p-8 bg-gray-100 mx-auto">
                    ...
                    <div>
                        <div className="flex justify-center">
                            <button className="h-16 w-16 bg-neutral-400 rounded-t-lg"
                                    onClick={() => onButtonClick(BUTTON.UP)}/>
                        </div>
                        <div className="flex justify-center">
                            <button className="h-16 w-16 bg-neutral-400 rounded-l-lg"
                                    onClick={() => onButtonClick(BUTTON.LEFT)}/>
                            <div className="h-16 w-16 bg-neutral-400"/>
                            <button className="h-16 w-16 bg-neutral-400 rounded-r-lg"
                                    onClick={() => onButtonClick(BUTTON.RIGHT)}/>
                        </div>
                        <div className="flex justify-center">
                            <button className="h-16 w-16 bg-neutral-400 rounded-b-lg"
                    ...
                    <div>
                        <div className="flex justify-center space-x-4">
                            <button className="h-6 w-16 bg-neutral-400 rounded-full"
                                    onClick={() => onButtonClick(BUTTON.MIDDLE1)}/>
                            <button className="h-6 w-16 bg-neutral-400 rounded-full"
                                    onClick={() => onButtonClick(BUTTON.MIDDLE2)}/>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="flex justify-center space-x-4">
                            <button className="h-16 w-16 bg-red-600 rounded-full"
